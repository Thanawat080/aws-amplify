...
const routes = [
...

  {
    path: '/report',
    name: 'report',
    component: () => import('../views/report.vue')// set login as path '/login'
  },
    
  {
    path: '/reportinformation/:id',
    name: 'reportinformation',
    component: () => import('../views/reportinformation.vue')// set login as path '/login'
  },
